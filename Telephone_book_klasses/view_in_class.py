...
def show_all_contacts(book: list[classes.Contact], message: str):
    if book:
        print('\n' + '=' * 90)
...
def change_contact(book: list, message: str) -> tuple[int, classes.Contact]:
    index = 0
    while True:
